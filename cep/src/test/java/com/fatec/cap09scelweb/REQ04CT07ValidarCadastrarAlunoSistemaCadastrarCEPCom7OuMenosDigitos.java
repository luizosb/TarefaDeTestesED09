...
import java.net.URL;
public class REQ04CT07ValidarCadastrarAlunoSistemaCadastrarCEPCom7OuMenosDigitos  {
  ...
  @Test
  public void rEQ04CT07ValidarCadastrarAlunoSistemaCadastrarCEPCom7OuMenosDigitos () {
    ...
    driver.findElement(By.id("cep")).sendKeys("0355407");
