...
import java.net.URL;
public class REQ05CT01ValidarCadastrarAlunoComCEPInvalidoApresentaMensagemErro<WebDriver, JavascriptExecutor> {
  ...
  @Test
  public void rEQ05CT01ValidarCadastrarAlunoComCEPInvalidoApresentaMensagemErro() {
