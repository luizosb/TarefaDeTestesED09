...
import java.net.URL;
public class REQ04CT02ValidarCadastrarAlunoSistemaDeixaCadastrarRAComCincoOuMaisDigitos<WebDriver, JavascriptExecutor> {
  ...
  @Test
  public void rEQ04CT02ValidarCadastrarAlunoSistemaDeixaCadastrarRAComCincoOuMaisDigitos() {
    driver.get("https://ts-scel.herokuapp.com/");
    driver.manage().window().setSize(new Dimension(550, 692));
    driver.findElement(By.linkText("Alunos")).click();
    driver.findElement(By.id("ra")).click();
    driver.findElement(By.id("ra")).sendKeys("11113");
