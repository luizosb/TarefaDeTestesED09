...
import java.net.URL;
public class REQ04CT05ValidarEhPossivelCadastrarEmailCom51OuMaisCaracteres<WebDriver, JavascriptExecutor> {
  ...
  @Test
  public void rEQ04CT05ValidarEhPossivelCadastrarEmailCom51OuMaisCaracteres () {
    ...
    driver.findElement(By.id("email")).sendKeys(Keys.DOWN);
    driver.findElement(By.id("email")).sendKeys(Keys.DOWN);
    driver.findElement(By.id("email")).sendKeys("luizluizluizluizluizluizluizluizluizluizluiz@fatec.com");
